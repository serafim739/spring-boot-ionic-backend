package com.nivaldoSerafim.cursomc;
...
import com.nivaldoSerafim.cursomc.domain.Pagamento;
import com.nivaldoSerafim.cursomc.domain.PagamentoComBoleto;
import com.nivaldoSerafim.cursomc.domain.PagamentoComCartao;
...
import com.nivaldoSerafim.cursomc.domain.enums.TipoCliente;
import com.nivaldoSerafim.cursomc.repositories.CategoriaRepository;
import com.nivaldoSerafim.cursomc.repositories.CidadeRepository;
import com.nivaldoSerafim.cursomc.repositories.ClienteRepository;
import com.nivaldoSerafim.cursomc.repositories.EnderecoRepository;
import com.nivaldoSerafim.cursomc.repositories.EstadoRepository;
import com.nivaldoSerafim.cursomc.repositories.ItemPedidoRepository;
...
public class CursomcApplication implements CommandLineRunner  {
	...
	public void run(String... args) throws Exception {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "400.400.400-40", TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("27363323", "9383-8393"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38.220-834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avanida Matos", "105", "Sala 800", "Centro", "38.777-012", cli1, c2);
